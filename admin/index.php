...
<html lang="en">
<head>
<title>Sports System Admin</title>
<meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Perfect Sports Admin</a></h1>
</div>
<!--close-Header-part--> 
          ...
          <div class="row-fluid">
            ...
            <div class="span4">
              <ul class="site-stats">
                ...
                <li class="bg_lr"><i class="fas fa-user-ninja"></i> <strong><?php include 'actions/count-trainers.php';?></strong> <small>Active Sports Trainers</small></li>
      ...
      <div class="span6">
        <div class="widget-box">
          <div class="widget-title bg_ly" data-toggle="collapse" href="#collapseG2"><span class="icon"><i class="fas fa-chevron-down"></i></span>
            <h5>Registered Sports Members by Gender: Overview</h5>
          </div>
