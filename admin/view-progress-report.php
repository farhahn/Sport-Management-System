...
<html lang="en">
<head>
<title>Sport System Admin</title>
<meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Sport  Admin</a></h1>
</div>
<!--close-Header-part--> 
            ...
            <div class="row-fluid">
              <div class="span4">
                <table class="">
                  <tbody>
                  <tr>
                      <td><h4>Perfect Sports</h4></td>
                    </tr>
                    <tr>
                      <td>Jalhandhar Punjab</td>
                    </tr>
                    ...
                    <tr>
                      <td >Email: support@perfectsport.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div class="span8">
                <table class="table table-bordered table-invoice-full">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><div class="text-center"><?php echo $row['ini_weight']; ?> Practice</div></td>
                ...
                <table class="table table-bordered table-invoice-full">
                  <tbody>
                    <tr>
                      <td class="msg-invoice" width="55%"> <div class="text-center"><h5><?php echo $row['fullname']; ?>'s Body Structure stated as from <?php echo $row['ini_bodytype']; ?> to <?php echo $row['curr_bodytype']; ?>. <br /> With Total Practice Differences of <?php include 'actions/weight-diff.php';?> KG <br /> As per records of <?php echo $row['progress_date']; ?></h5>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Developed By Farhan & Yaseen</a> </div>
</div>
